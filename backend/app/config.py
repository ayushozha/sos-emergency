...
class Settings(BaseSettings):
    ...
    # --- OpenAI Realtime voice (speech-to-speech via gpt-realtime-2) ---------
    # Secret. Required for /v1/voice/agent. Get one at https://platform.openai.com
    openai_api_key: str = ""

    # OpenAI Realtime model + voice. See https://developers.openai.com/api/docs/models/gpt-realtime-2
    voice_realtime_model: str = "gpt-realtime-2"
    ...
    voice_input_sample_rate: int = 24000
    voice_output_sample_rate: int = 24000

    # Optional override for the emergency-dispatcher instructions. Empty means
    # use the built-in default in app/voice_prompt.py.
    voice_dispatcher_prompt: str = ""

    # Legacy Deepgram key (unused when OpenAI Realtime is active).
