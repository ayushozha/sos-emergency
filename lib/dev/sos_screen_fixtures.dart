...
/// Human-readable labels for the handoff screen picker.
const Map<String, String> handoffScreenLabels = {
  'opening_triage': 'Opening triage',
  'serious_crash': 'Serious crash',
  'being_followed': 'Being followed (day)',
  'being_followed_night': 'Being followed (night)',
  'suspected_heart_attack': 'Suspected heart attack',
  'flat_tire': 'Flat tire on shoulder',
  'wont_start_offline': "Won't start · no signal",
};
